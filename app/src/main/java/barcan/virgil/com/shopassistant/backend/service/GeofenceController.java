...
public class GeofenceController {
    ...
    public void init(Context context) {
        System.out.println("GeofenceController.init");
    ...
    public void addGeofence(NamedGeofence namedGeofence, GeofenceControllerListener listener) {
        System.out.println("GeofenceController.addGeofence");
    ...
    public void removeGeofences(List<NamedGeofence> namedGeofencesToRemove, GeofenceControllerListener listener) {
        System.out.println("GeofenceController.removeGeofences");
    ...
    public void removeAllGeofences(GeofenceControllerListener listener) {
        System.out.println("GeofenceController.removeAllGeofences");
        namedGeofencesToRemove = new ArrayList<>();
    ...
    private void loadGeofences() {
        System.out.println("GeofenceController.loadGeofences");
        ...
        namedGeofenceAltex.setName("Altex");
        namedGeofenceAltex.setLatitude(47.155441);
        namedGeofenceAltex.setLongitude(27.604732);
        namedGeofenceAltex.setRadius((float) 0.5);
        namedGeofences.add(namedGeofenceAltex);

        NamedGeofence namedGeofenceContinental = new NamedGeofence();
        namedGeofenceContinental.setName("Continental");
        namedGeofenceContinental.setLatitude(47.137192);
        namedGeofenceContinental.setLongitude(27.598248);
        namedGeofenceContinental.setRadius((float) 0.5);
        namedGeofences.add(namedGeofenceContinental);

        for (NamedGeofence namedGeofence : namedGeofences)
            System.out.println("GeofenceController.loadGeofences: namedGeofence=" + namedGeofence.toString());
    }


    private void connectWithCallbacks(GoogleApiClient.ConnectionCallbacks callbacks) {
        System.out.println("GeofenceController.connectWithCallbacks");
    ...
    private GeofencingRequest getAddGeofencingRequest() {
        System.out.println("GeofenceController.getAddGeofencingRequest");
    ...
    private void saveGeofence() {
        System.out.println("GeofenceController.saveGeofence");
    ...
    private GoogleApiClient.ConnectionCallbacks connectionAddListener = new GoogleApiClient.ConnectionCallbacks() {
        ...
        public void onConnected(Bundle bundle) {
            System.out.println("GeofenceController.onConnected");
            ...
            result.setResultCallback(new ResultCallback<Status>() {
                ...
                public void onResult(Status status) {
                    System.out.println("GeofenceController.onResult");
                    if (status.isSuccess()) {
                        saveGeofence();
                    } else {
    ...
    private GoogleApiClient.ConnectionCallbacks connectionRemoveListener = new GoogleApiClient.ConnectionCallbacks() {
        ...
        public void onConnected(Bundle bundle) {
            ...
            for (NamedGeofence namedGeofence : namedGeofencesToRemove) {
                removeIds.add(namedGeofence.getId());
            }
